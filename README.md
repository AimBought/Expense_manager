# 💸 Expense Manager – Qt Project

Expense Manager is a desktop application built with C++ and the Qt framework, designed to help users manage and track their daily expenses. 
